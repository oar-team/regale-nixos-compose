...
* Deadline heuristic is similar to Punch Annotated but a deadline provided.

The Deadline goal is to run before a given deadline. Because it does not follow the same objective it is not compared to the others.
